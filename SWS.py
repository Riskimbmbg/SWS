...
mengetik(f"{P} ∎   ∎                                   ∎   ∎")
mengetik(f"{P} ∎   ∎∎∎∎∎∎∎∎∎∎∎∎∎>LOGIN  SC<∎∎∎∎∎∎∎∎∎∎∎∎∎   ∎")
time.sleep(1.5)
mengetik(f"{O} ∎--> Sedang Mengecek Koneksi [ᯤ]")
print("")
time.sleep(2)

# animasi loading
mengetik(f"{O} [㐃] Mendownload Bahan")
time.sleep(2)
print("")
mengetik(f"{M} [•] Tunggu Slurr [~]")
time.sleep(5)
print("")
mengetik(f"{O} Succes Mendownload Bahan [✓]")
time.sleep(4)
...
mengetik(f"{P} ∎   ∎        GitHub  : Riskimbmbg       ∎   ∎")
mengetik(f"{P} ∎   ∎                                   ∎   ∎")
mengetik(f"{P} ∎   ∎∎∎∎∎∎∎∎∎∎∎∎∎>Unli Spam<∎∎∎∎∎∎∎∎∎∎∎∎∎   ∎")
print("")
time.sleep(2)
mengetik(f"{H}          SCRIPT SPAM WA + SMS 2022")
print("")
...
'content-type': 'application/json',
'accept': '*/*',
'user-agent': 'Mozilla/5.0 (Linux; Android 11; Redmi 9T) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Mobile Safari/537.36',
